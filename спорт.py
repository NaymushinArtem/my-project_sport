...
if __name__ == '__main__':
    ...
    # Этап 2: Стадия проектирования
    Задача 2.1: Архитектурное проектирование
    Задача 2.2: Проектирование пользовательского интерфейса
    Задача 2.3: Проектирование базы данных